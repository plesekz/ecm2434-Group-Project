...
urlpatterns = [
    ...
    path('buyPAthletics/', processes.buyPAthletics, name="buyptoughness"),
    path('buyPBrain/', processes.buyPBrain, name="buypevasion"),
    path('buyPControl/', processes.buyPControl, name="buydamage"),
